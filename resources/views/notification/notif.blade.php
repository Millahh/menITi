...
<body>
    @if(auth()->user()->role == 1)
    <div class="judul mb-5" style="cursor:pointer;" onclick="window.location='{{ url('/beranda-mentee'); }}'">
        <i class="fa-lg fa-solid fa-chevron-left"></i>
        <p class="d-inline-block ml-3 tosca">Pemberitahuan</p>
    </div>
    @else
    <div class="judul mb-5" style="cursor:pointer;" onclick="window.location='{{ url('/beranda-mentor'); }}'">
        <i class="fa-lg fa-solid fa-chevron-left"></i>
        <p class="d-inline-block ml-3 tosca">Pemberitahuan</p>
    </div>
    @endif
